...
<meta name="description" content="Illustrations by John Suarez" />
...
<table width="100%" height="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    <td>&nbsp;</td>
    <td align="center" valign="middle" id="preview"><img src="images/john_suarez/1.png" alt=" " width="428" height="305" border="0" /></td>
    <td>&nbsp;</td>
  </tr>
  <tr>
    <td>&nbsp;</td>
...
<table width="100%" border="0" cellspacing="2" cellpadding="2">
  <tr>
    <td width="16%">&nbsp;</td>
    <td width="36%">&nbsp;</td>
    <td width="48%" align="right">[John Suarez]</td>
  </tr>
  <tr>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
          ...
          <td><table width="100%" border="0" cellspacing="2" cellpadding="1">
            ...
            <tr>
              ...
              <td><table width="100%" border="0" cellspacing="2" cellpadding="1">
                <tr>
                  <td width="6%">&nbsp;</td>
                  <td width="94%"><a href="sarah.php" target="_self" onmouseover="animate_sub_sub_link('sarah')" onmouseout="hide_sub_sub_link_animation('sarah', 75)"><img src="images/sarah.png" width="200" height="13" border="0" /></a></td>
                </tr>
                <tr>
                  <td>&nbsp;</td>
                ...
                <tr>
                  <td>&nbsp;</td>
                  <td><img src="images/john_s.png" width="200" height="16" border="0" /></td>
                </tr>
                <tr>
                  <td>&nbsp;</td>
...
<script language="javascript" type="text/javascript">	
	animate_selected_sub_sub_link('john_s');	
</script>

<script language="javascript" src="jhon_s_scroller.js"></script>
</html>
