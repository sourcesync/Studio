...
<meta name="description" content="Illustrations by Anthony Marte" />
...
<body>
<!-- -->
<img src="../../images_template_artists.png" width="846" height="530" style="position:absolute; left: 14px; top: 36px; z-index:1"  />
...
<table border="0" cellspacing="0" cellpadding="0" id="image_table" style="position:relative; right:0px; cursor:pointer;" onmouseout="checkBounderies()">
    <tr>
      ...
      <td><img src="../../images/bar.png" width="2" border="0" /></td>
      <td><div id="13" class="imageSlideThumbs" onclick="previewImage(this)"></div></td>
      <td><img src="../../images/bar.png" width="2" border="0" /></td>
      <td><div id="14" class="imageSlideThumbs" onclick="previewImage(this)"></div></td>
      <td><img src="../../images/bar.png" width="2" border="0" /></td>
      <td><div id="15" class="imageSlideThumbs" onclick="previewImage(this)"></div></td>
      <td><img src="../../images/bar.png" width="2" border="0" /></td>
      <td><div id="16" class="imageSlideThumbs" onclick="previewImage(this)"></div></td>
      <td><img src="../../images/bar.png" width="2" border="0" /></td>
      <td><div id="17" class="imageSlideThumbs" onclick="previewImage(this)"></div></td>
      <td><img src="../../images/bar.png" width="2" border="0" /></td>
      <td><div id="18" class="imageSlideThumbs" onclick="previewImage(this)"></div></td>
      <td><img src="../../images/bar.png" width="2" border="0" /></td>
...
<table width="100%" height="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    <td>&nbsp;</td>
    <td align="center" valign="middle" id="preview"><img src="images/anthony_marte/1.png" alt=" " width="428" height="305" border="0" /></td>
    <td>&nbsp;</td>
  </tr>
  <tr>
    <td>&nbsp;</td>
...
<div id="down_section" style="position:absolute; width: 460px; height: 122px; left: 321px; top: 459px; z-index:3;">
<table width="100%" border="0" cellspacing="2" cellpadding="2">
  <tr>
    <td width="16%">&nbsp;</td>
    <td width="46%">&nbsp;</td>
    <td width="38%" align="right">[Anthony Marte]</td>
  </tr>
  <tr>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
...
<table width="1364" border="0" cellspacing="0" cellpadding="0" style="position:absolute">
      <tr>
...
<br /><br /><br />
      ...
      <table width="300" border="0" cellspacing="2" cellpadding="2" style="z-index:5; position:absolute; left: 17px; top: 65px;">
          ...
          <td><table width="100%" border="0" cellspacing="2" cellpadding="1">
            ...
            <tr>
              ...
              <td><table width="100%" border="0" cellspacing="2" cellpadding="1">
                <tr>
                  <td width="6%">&nbsp;</td>
                  <td width="94%"><a href="sarah.php" target="_self" onmouseover="animate_sub_sub_link('sarah')" onmouseout="hide_sub_sub_link_animation('sarah', 75)"><img src="images/font_final2/sarah.png" width="200" height="13" border="0" /></a></td>
                </tr>
                <tr>
                  <td>&nbsp;</td>
                ...
                <tr>
                  <td>&nbsp;</td>
                  <td><img src="images/font_final2/anthony.png" width="200" height="16" border="0" /></td>
                </tr>
		<!--
                <tr>
                  <td>&nbsp;</td>
		...
		<!--gw 10/5/2011 removed
                <tr>
                  <td>&nbsp;</td>
                  <td><a href="john_s.php" target="_self" onmouseover="animate_sub_sub_link('john_s')" onmouseout="hide_sub_sub_link_animation('john_s', 75)"><img src="font_final2/john.png" width="200" height="16" border="0" /></a></td>
                </tr>
		-->
                <!-- gw 10/5/2011 - george added -->
                <tr>
                  <td>&nbsp;</td>                  <td><a href="matt.php" target="_self" onmouseover="animate_sub_sub_link('matt')" onmouseout="hide_sub_sub_link_animation('matt', 75)"><img src="images/font_final2/matt.png" width="200" height="13" border="0" /></a></td>
                </tr>
                <tr>
                  <td>&nbsp;</td>
...
<script language="javascript" type="text/javascript">	
	animate_selected_sub_sub_link('anthony');	
</script>

<script language="javascript" src="anthony_scroller.js"></script>
</html>
