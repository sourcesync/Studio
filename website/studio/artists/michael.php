...
<meta name="description" content="Illustrations by Michael Ocasio" />
...
<table width="100%" height="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    <td>&nbsp;</td>
    <td align="center" valign="middle" id="preview"><img src="images/michael_ocasio/1.png" alt=" " width="428" height="305" border="0" /></td>
    <td>&nbsp;</td>
  </tr>
  <tr>
    <td>&nbsp;</td>
...
<table width="100%" border="0" cellspacing="2" cellpadding="2">
  <tr>
    <td width="16%">&nbsp;</td>
    <td width="36%">&nbsp;</td>
    <td width="48%" align="right">[Michael Ocasio]</td>
  </tr>
  <tr>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
...
<br /><br /><br />
      ...
      <table width="300" border="0" cellspacing="2" cellpadding="2" style="z-index:5; position:absolute; left: 17px; top: 65px;">
		...
		-->
                ...
                <tr>
                  <td>&nbsp;</td>
                  <td><img src="images/font_final2/michael.png" width="200" height="13" border="0" /></td>
                </tr>
                <tr>
                  <td>&nbsp;</td>
...
<script language="javascript" type="text/javascript">	
	animate_selected_sub_sub_link('michael');	
</script>

<script language="javascript" src="michael_scroller.js"></script>
</html>
