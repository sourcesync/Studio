...
<meta name="description" content="Illustrations by David Lee" />
...
<link rel="stylesheet" type="text/css" href="../../scripts/common.css" /></head>
...
<table width="100%" height="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    <td>&nbsp;</td>
    <td align="center" valign="middle" id="preview"><img src="images/david_lee/1.png" alt=" " width="428" height="305" border="0" /></td>
    <td>&nbsp;</td>
  </tr>
  <tr>
    <td>&nbsp;</td>
...
<div id="down_section" style="position:absolute; width: 460px; height: 122px; left: 321px; top: 460px; z-index:3;">
<table width="100%" border="0" cellspacing="2" cellpadding="2">
  <tr>
    <td width="16%">&nbsp;</td>
    <td width="52%">&nbsp;</td>
    <td width="32%" align="right">[David Lee]</td>
  </tr>
  <tr>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
          ...
          <td><table width="100%" border="0" cellspacing="2" cellpadding="1">
            ...
            <tr>
              ...
              <td><table width="100%" border="0" cellspacing="2" cellpadding="1">
                ...
                <tr>
                  <td>&nbsp;</td>
                  <td><img src="images/font_final2/david.png" width="200" height="13" border="0" /></td>
                </tr>
                <tr>
                  <td>&nbsp;</td>
...
<script language="javascript" type="text/javascript">	
	animate_selected_sub_sub_link('david');	
</script>

<script language="javascript" src="david_scroller.js"></script>
</html>
