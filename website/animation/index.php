...
<table width="872" height="100%" border="0" cellspacing="0" cellpadding="0" id="image_table" style="position:relative; right:0px; cursor:pointer;" onmouseout="checkBounderies()">
    <tr>
...
<table width="100%" height="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    ...
    <video id="theVideo" width="480" height="282" poster="shorts/1.png" controls="controls" preload="auto">
        ...
        <source type="video/mp4" src="shorts/sd/1.mp4video.mp4" />
        <!-- Ogg/Vorbis for older Firefox and Opera versions -->
        <source type="video/ogg" src="shorts/sd/1.theora.ogv" />
        ...
        <object width="480" height="282" type="application/x-shockwave-flash" data="shorts/flashmediaelement.swf">
            ...
            <param name="flashvars" value="controls=true&poster=shorts/1.png&file=shorts/sd/1.mp4video.mp4" />
    ...
    <div onclick="reloadAgain()" style=" height:282px; width:480px;">
        <object id="wmp" height="282" width="480" classid="clsid:6BF52A52-394A-11d3-B153-00C04F79FAA6" type="application/x-oleobject">
			...
			<param name="url" value="shorts/sd/1.wmv">
...
<table width="100%" border="0" cellspacing="2" cellpadding="2">
  <tr>
    <td colspan="3" align="right" id="slide_data">'Snow Globe', Story by Todd Eisner</td>
    </tr>
  <tr>
      ...
      <table width="300" border="0" cellspacing="2" cellpadding="2" style="z-index:5; position:absolute; left: 17px; top: 65px;">
        ...
        <tr>
          <td><table width="100%" border="0" cellspacing="1" cellpadding="0">
            ...
            <tr>
              <td>&nbsp;</td>
              <td><a href="commercial.php" target="_self" onmouseover="animate_sub_link('commercial')" onmouseout="hide_sub_link_animation('commercial', 75)"><img src="../images/commercial.png" width="250" height="14" border="0" /></a></td>
            </tr>
          </table></td>
        </tr>
        <tr>
...
<script language="javascript" src="shorts/lovell_scroller.js"></script>
