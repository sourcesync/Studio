...
var CURRENT_URL = "http://www.studionyc.com/animation/commercial.php";
...
for (i = 1; i < (total_images + 1); i++)
{
	...
	image_cells[i].style.backgroundImage =  "url(commercial/thumbs/red_preview_" + i + ".png)";
	image_preview[i] = '<div id="preview_div" style="background-image:url(commercial/' + i + '.png); height:281px; width:480px; overflow:hidden;" align="center"  onclick="setVideo(\'commercial\')"><table width="100%" height="100%" border="0" cellspacing="0" cellpadding="0">  <tr> <td align="center" valign="middle"></td>  </tr></table></div>';
