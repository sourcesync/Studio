	...
	/////// SELECTED SUB SUB LINK
			selected_link["contact"] = document.createElement("img");
			selected_link["contact"].setAttribute("src", "../images/links/selected/1.gif");
			selected_link["contact"].setAttribute("height", "28");
			selected_link["contact"].setAttribute("width", "250");
			selected_link["contact"].style.zIndex = 2;
			selected_link["contact"].setAttribute("alt", "");
			selected_link["contact"].style.position = "absolute";
			selected_link["contact"].style.top = (288 + absolute_shift) + "px";
			selected_link["contact"].style.left = menu_left + "px";
			selected_link["contact"].style.visibility = "hidden";
			document.body.appendChild(selected_link["contact"]);	
