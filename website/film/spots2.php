...
<script src="spots/mediaelement-and-player.min.js"></script>
<script src="spots/mediaelement.js"></script>
<link rel="stylesheet" href="spots/mediaelementplayer.css" />
...
<table width="220" height="100%" border="0" cellspacing="0" cellpadding="0" id="image_table" style="position:relative; right:0px; cursor:pointer;" onmouseout="checkBounderies()">
    <tr>
  ...
  <tr>
    ...
    <td colspan="2" align="left">    
      ...
      <table width="100" border="0" cellspacing="2" cellpadding="2" id="social" style="opacity:0.0;filter:alpha(opacity=0);visibility:hidden; position:relative;">
        <tr>
          <td width="50"><a id="share_email" href="mailto:.com?subject=Director&body=Check out this reel: http://www.studionyc.com/film/spots2.php"><img src="../images/mini/email.png" width="16" height="16" border="0" onmouseover="swapEffect(this, '../images/mini/email_colored.png');ToolTip('E-Mail')" onmouseout="swapEffect(this, '../images/mini/email.png');ToolTip('&nbsp;')"/></a></td>
          <td width="50"><a id="share_facebook" href="https://www.facebook.com/sharer.php?u=http://www.studionyc.com/film/spots2.php" target="_blank"><img src="../images/mini/facebook.png" width="16" height="16" border="0" onmouseover="swapEffect(this, '../images/mini/facebook_colored.png');ToolTip('Facebook')" onmouseout="swapEffect(this, '../images/mini/facebook.png');ToolTip('&nbsp;')"/></a></td>
          <td width="50"><a id="share_twitter" href="https://twitter.com/share?url=http://www.studionyc.com/film/spots2.php" target="_blank"><img src="../images/mini/twitter.png" width="16" height="16" border="0" onmouseover="swapEffect(this, '../images/mini/twitter_colored.png');ToolTip('Twitter')" onmouseout="swapEffect(this, '../images/mini/twitter.png');ToolTip('&nbsp;')"/></a></td>
          <td width="50"><a id="share_delicious" href="https://secure.delicious.com/login?jump=http://www.studionyc.com/film/spots2.php" target="_blank"><img src="../images/mini/delicious.png" width="16" height="16" border="0" onmouseover="swapEffect(this, '../images/mini/delicious_colored.png');ToolTip('Delicious')" onmouseout="swapEffect(this, '../images/mini/delicious.png');ToolTip('&nbsp;')"/></a></td>
          <td width="50"><a id="share_stumbleupon" href="http://www.stumbleupon.com/submit?url=http://www.studionyc.com/film/spots2.php" target="_blank"><img src="../images/mini/stumbleupon.png" width="16" height="16" border="0" onmouseover="swapEffect(this, '../images/mini/stumbleupon_colored.png');ToolTip('StumbleUpon')" onmouseout="swapEffect(this, '../images/mini/stumbleupon.png');ToolTip('&nbsp;')"/></a></td>
          ...
          <td width="50"><a id="share_digg" href="http://digg.com/submit?url=http://www.studionyc.com/film/spots2.php" target="_blank"><img src="../images/mini/digg.png" width="16" height="16" border="0" onmouseover="swapEffect(this, '../images/mini/digg_colored.png');ToolTip('Digg')" onmouseout="swapEffect(this, '../images/mini/digg.png');ToolTip('&nbsp;')"/></a></td>
...
<br /><br /><br />
      ...
      <table width="300" border="0" cellspacing="2" cellpadding="2" style="z-index:5; position:absolute; left: 17px; top: 65px;">
		...
		<tr>
              <td>&nbsp;</td>
              <td><a href="director2.php" target="_self" onmouseover="animate_sub_link('director')" onmouseout="hide_sub_link_animation('director', 75)"><img src="../images/director.png" width="200" height="16" border="0" /></a></td>
            </tr>
            <tr>
              <td>&nbsp;</td>
            ...
            <tr>
              <td width="7%">&nbsp;</td>
              <td width="93%"><img src="../images/spots_6.png" width="139" height="16" border="0" /></td>
            </tr>
          	</table>
	  </td>
        </tr>
...
<script language="javascript" src="spots/lovell_scroller2.js"></script>
<script language="javascript" src="spots/post_video_load2.js"></script>
<script language="javascript" src="spots/spots.js"></script>
</html>
