...
// 10
slide_title.push("");
slide_text.push('Marie Dvorakova');
slide_info.push("Marie Dvorakova");
slide_max_scroll.push(180);


// 7
slide_title.push("");
slide_text.push('Eriq Wities');
slide_info.push("Eriq Wities");
slide_max_scroll.push(180);

// 8
slide_title.push("");
slide_text.push('Spyros Dahlias');
slide_info.push("Spyros Dahlias");
slide_max_scroll.push(180);

// 9
slide_title.push("");
slide_text.push('Matthew Lester');
slide_info.push("Matthew Lester");
slide_max_scroll.push(180);
...
//for (i = 1; i < (total_images + 1); i++)
{
	...
	thidx = arrMap[i];
	image_cells[i].style.backgroundImage =  "url(director/thumbs/red_preview_" + thidx + ".png)";
	image_preview[i] = '<div id="preview_div" style="background-image:url(director/' + thidx + '.png); height:281px; width:480px; overflow:hidden;" align="center" onclick="setVideo(\'director\')"><table width="100%" height="100%" border="0" cellspacing="0" cellpadding="0">  <tr> <td align="center" valign="middle"><img src="../images/play.png" width="50" height="50" border="0"/></td>  </tr></table></div>';
...
function coverWithRed()
{
	...
	for (ii = 0; ii < (total_images ); ii++)
	{
		...
		if (image_cells[ii].style.backgroundImage == "")
			image_cells[ii].style.backgroundImage =  "url(director/thumbs/red_preview_" + tthidx + ".png)";
	}
}
...
function previewImage(theObject)
{
	...
	theObject.innerHTML = '<img src="director/thumbs/preview_' + thidx + '.png" width="107" height="60" border="0" />';
