...
<br /><br /><br />
      ...
      <table width="300" border="0" cellspacing="2" cellpadding="2" style="z-index:5; position:absolute; left: 17px; top: 65px;">
        ...
        <tr>
          <td><a href="animation/index.php" target="_self" onmouseover="animate_link('animation')" onmouseout="hide_link_animation('animation', 0)"><img src="images/animation.png" width="256" height="31" border="0" alt="animation" title="" /></a></td>
        </tr>
        <tr>
